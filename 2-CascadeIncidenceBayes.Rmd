...
if (useSaved) {
  ...
  # Alternatives
  f4 <- rtriangle(numBayesSamples, 0, 0.5, 0.2) * 
    runif(numBayesSamples, errN4[1], errN4[2])
  # rbeta(numBayesSamples, 1.4, 15) or thereabouts
  ...
  if (saveSims){
    # Save the output
    save(numBayesSamples, priorApproach, 
...
if (useSaved) {
  ...
  if (saveOutputs){
    ...
    save(cascadeBestBayes, numBayesSamples, beta1, beta2, beta3, beta4,
