...
numBayesSamples <- 1e4 # number of prior samples
...
f4opt2 <- list(dist = "beta", params = c(1.2, 15))         # new beta
f4opt3 <- list(dist = "triangle", params = c(0, 0.5, 0.2)) # triangle
...
if (useSaved) {
  ...
  if (priorApproach == "independent") {
    ...
    # If independent calculate multiplicative factor (f) values
    f1 <- beta1 / beta2
    f3 <- beta3 / beta2
    ...
    beta2 <- runif(numBayesSamples, 
                   beta[1] * errN2[1], 
                   beta[2] * errN2[2])
    beta2 <- runif(numBayesSamples, beta[1], beta[2]) * 
      runif(numBayesSamples, errN2[1], errN2[2])
  
    f1 <-runif(numBayesSamples, beta1Rel[1], beta1Rel[2]) * 
      runif(numBayesSamples, errN1[1], errN1[2])
    f3 <-runif(numBayesSamples, beta3Rel[1], beta3Rel[2]) * 
