...
# Specify f4 prior 
f4Prior <- SuppressedOption("option8")
...
if (useSaved) {
  ...
  simTime <- "2016-08-04(00-26)" # in %Y-%m-%d(%H-%M) format 
                                  # or some other name
...
hist(f2start, breaks = 100) # prior
hist(f2start[resampleIndices], breaks = 100) # posterior 
hist(f2end[resampleIndices], breaks = 100) # posterior 
