...
medBeta1 <- median(beta1[resampleIndices])
medBeta2 <- median(beta2[resampleIndices])
medBeta3 <- median(beta3[resampleIndices])
medBeta4 <- median(beta4[resampleIndices])

BetaMed <- c(medBeta1, medBeta2, medBeta3, medBeta4)
BetaRelMed <- BetaMed / BetaMed[2]

# How good is the fit ----------------------------------------------------

incMed <- IncFunc(cascadeBest, medBeta1, medBeta2, medBeta3, medBeta4)
...
hist(f3[resampleIndices], breaks = 100) # posterior
hist(f3, breaks = 100) # prior

hist(beta4[resampleIndices], breaks = 100) # posterior
hist(beta1, breaks = 100) # prior

hist(log(beta4[resampleIndices]), breaks = 100) # posterior
hist(log(beta4), breaks = 100) # prior
...
propInfectsMed <- PropInfections(cascadeData, BetaMed)
