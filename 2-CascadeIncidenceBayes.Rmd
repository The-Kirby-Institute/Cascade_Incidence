...
errorRange <- hivCascade %>%
  ...
  summarise(errlower = mean(lower/value),
            ...
            start_lower = lower[1] / value[1],
            start_upper = upper[1] / value[1],
...
if (useSaved) {
  ...
  if (useError) {
    # Use estimates from error range 
...
hist(errf4[resampleIndices], breaks = 1000)
