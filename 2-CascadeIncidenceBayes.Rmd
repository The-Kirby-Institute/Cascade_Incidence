...
incError <- TRUE # False if do not want to include cascade error
...
simsSeed <- 75321 #Set to an integer to reproduce results 
                   #54321 - 2015Partner
                   #12345 - 2015Zero
                   #12357 - 2015Cohen
                   #75321 - 2015Noerror (Partner)
                   #2468  - 2014Cohen (or Partner?)
if (!is.null(simsSeed)) {
  set.seed(simsSeed)
} else {
...
# Specify f4 prior 
suppressOption <- "option9" # option6 for Cohen 2011
                               # option9 for PARTNER study
                               # optionZero for no transmission
...
resampleSeed <- 10864 # Set to an integer to reproduce results 
                           #2357 - 2015Partner
                           #7532 - 2015Zero
                           #46810 - 2015Cohen
