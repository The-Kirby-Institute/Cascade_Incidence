...
numBayesSamples <- 1e5 #5e6 # number of prior samples
...
if (useSaved) {
  ...
  if (suppressOption == "option9") {
    beta4prior <- SuppressedOption(suppressOption)
    beta4start <- PriorSample(numBayesSamples, beta4prior$dist,
                              beta4prior$params)
    beta4end <- PriorSample(numBayesSamples, beta4prior$dist, 
                            beta4prior$params)
