...
comparePlot <- ggplot(data = cascadeBest, aes(x = year, y = infections)) +
  ...
  geom_line(aes(y = apply(incidenceMatrix[resampleIndices, ], 2, mean),
                colour = "bayesMean")) +
  # geom_line(aes(y = bayesIncMed, colour = "bayesMed")) +
  geom_line(aes(y = newInfects$upper), colour = "black") +
  geom_line(aes(y = newInfects$lower_npd), colour = "black") +
  coord_cartesian(ylim = c(0, 1500)) + 
  scale_colour_manual(name = "",
    limits = c("data", "bayesMean"), 
