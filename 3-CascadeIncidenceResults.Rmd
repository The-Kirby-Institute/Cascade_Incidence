...
bayesAnalysisTime <- "2016-08-04(00-26)" 
fileTag <- "ecdc"
...
bayesIncMed <- IncFuncTV(cascadeBest, 
                      betaMedStart[1], betaMedEnd[1],
                      betaMedStart[2], betaMedEnd[2],
                      betaMedStart[3], betaMedEnd[3],
                      betaMedStart[4], betaMedEnd[4])
...
comparePlot <- ggplot(data = cascadeBest, aes(x = year, y = infections)) +
  ...
  geom_line(aes(y = bayesIncBest, colour = "bayes")) + 
  geom_line(aes(y = bayesIncMed, colour = "bayesMed")) +
  coord_cartesian(ylim = c(0, 1500)) + 
  scale_colour_manual(name = "",
    limits = c("data", "bayes", "bayesMed"), 
...
incPlotBaseMed <- ggplot(data = incNumbersMed, aes(x = year, y = infections,
                                                   fill = stage)) + 
  xlab("Year") +
  scale_fill_manual(values = plotCols, name = "", labels = legendLabels, 
                    limits = c("undiagnosed", "diagnosed", 
...
if (savePlots) {
  ...
  SaveFigure(outputFolder, "New_infections_stage_Best", incPlotNum)
  SaveFigure(outputFolder, "Prop_infections_stage_Best", incPlotProp)
