...
beta1PlotSE <- ParameterPlot("beta1", posteriorFrameStart,
  posteriorFrameEnd, stats = TRUE,
  distLabels =  c("2004 posterior (blue)", 
                  paste0(toString(analysisYear), "posterior (red)"))) 
...
undiagPercent2014 <- PercentInc("undiagnosed", percentFrame, 
                                years = analysisYear,
                            savefolder = saveFolder)
diagPercent2014 <- PercentInc("diagnosed", percentFrame, 
                              years = analysisYear,
                          savefolder = saveFolder)
...
xValues <- seq(2004, analysisYear, by = 5)
