...
if (undiagnosedOption == "linear") {
  ...
  ecdcEstimates <- c(14.63, 14.04, 13.38, 12.63, 11.89, 11.17, 10.60, 10.11,
                     9.70, 9.37, 9.13) / 100
  
  ecdcEstimatesLower <- c(13.79, 13.20, 12.49, 11.81, 11.19, 10.61, 9.99,
                          9.42, 9.04, 8.70, 8.06) / 100
  
  ecdcEstimatesUpper <- c(15.30, 14.71, 14.17, 13.41, 12.59, 11.89, 11.36,
                          10.95, 10.60, 10.40, 10.48) / 100
