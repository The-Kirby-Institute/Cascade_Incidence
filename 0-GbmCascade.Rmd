...
# estimate. 
undiagnosedOption <- "count"; # "count" or "linear"
if (undiagnosedOption == "linear") {
  startYearProp <- c(0.1, 0.06, 1.4) # c(best, lower, upper)
  # c(0.2,0.13, 0.30), c(0.3,0.2, 0.4), c(0.1, 0.06, 1.4)
  fileTag <- "Lower" # Add to file when saving results 
}
