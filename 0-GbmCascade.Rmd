...
diagnosis cascade for Australian gay and bisexual men. 
...
#Script parameters
saveplots <- TRUE
startYear <- 2005 # minimum assumed to be 2004 used for plotting
...
undiagnosedProp <- c(0.089, 0.058, 0.135)
...
plhiv <- pldhiv$value / (1 - undiagnosedProp[1])
plhivLower <- pldhiv$lower / (1 - undiagnosedProp[2])
plhivUpper <- pldhiv$upper / (1 - undiagnosedProp[3])
...
# Number undiagnosed
undiagnosed <- plhiv * undiagnosedProp[1]
undiagnosedLower <- plhivLower * undiagnosedProp[2]
undiagnosedUpper <- plhivUpper * undiagnosedProp[3]
...
# Number diagnosed not on treatment - have to be careful the minimum value # is not less than zero
