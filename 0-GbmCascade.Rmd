...
if (plotUndiagnosed) {
  ...
  # Use the specific estimate we want
  if (plotECDC) {
    undiagProp <- undiagPropECDC
    undiagLabel <- "ECDC estimate"
  } else {
    undiagProp <- undiagPropCascade
    undiagLabel <- "Cascade estimate"
  ...
  undiagPlot <- ggplot(data = undiagProp, aes(x = year)) +
    ...
    scale_colour_manual(name = "", 
                        labels = c(undiagLabel, "COUNT estimate"),
